...
$_LANG['log_action']['batch_add'] = '批量添加';
...
$_LANG['log_action']['Course'] = '课堂';
$_LANG['log_action']['CourseCat'] = '课堂分类';
$_LANG['log_action']['CourseList'] = '课程';
$_LANG['log_action']['Information'] = '干货';
$_LANG['log_action']['InformationAge'] = '干货年龄';
$_LANG['log_action']['InformationCat'] = '干货分类';
$_LANG['log_action']['InformationMaterial'] = '干货材料';
$_LANG['log_action']['InformationTheme'] = '干货主题';
$_LANG['log_action']['Kindergarten'] = '园区转让';
$_LANG['log_action']['KindergartenXuqiu'] = '园区需求';
$_LANG['log_action']['Meeting'] = '蜂会';
$_LANG['log_action']['Mall'] = '积分商品';
$_LANG['log_action']['ContactUs'] = '留言';
$_LANG['log_action']['Lottery'] = '积分抽奖';
$_LANG['log_action']['Recruitment'] = '岗位';
$_LANG['log_action']['ResumeCast'] = '简历';
$_LANG['log_action']['Resume'] = '简历';
$_LANG['log_action']['Reel'] = '卡卷';
...
$_LANG['log_action']['Comment'] = '用户评论';
$_LANG['log_action']['Black'] = '拉黑';
