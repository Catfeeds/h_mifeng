...
if (empty($_FILES) === false) {
	...
	/* 水印配置开始 */
	 ...
	 $water_img = $_SERVER['DOCUMENT_ROOT'].'/Public/water.png';//水印图片,默认填写空,请将图片上传至网站根目录的upfiles下,例: water.gif
	 $water_alpha = 60;//水印透明度   相反10为90%透明度
...
function imageWaterMark($groundImage, $waterPos=0, $waterImage='', $alpha=80, $waterText='', $water_fontfile, $textFont=9, $textColor='#FF0000'){
  ...
  if($isWaterImage){//图片水印
    ...
    //imagecopymerge($dst_im,$src_im,x,0,0,$src_info[0],$src_info[1],$alpha); 

     //支持png本身透明度的方式 
     imagecopy($dst_im,$src_im,0,0,0,$src_info[0],$src_info[1]); 
